    ...
    <div class="col-lg-8 col-md-10">
      ...
      <div class="player-section" style="margin: 20px 0; padding: 15px; background: #f8f9fa; border-radius: 8px;">
        ...
        <div id="playerStatus" style="margin-top: 15px; padding: 10px; border-radius: 5px; display: none;">
          <small style="color: #28a745;">✅ Ready to save scores!</small>
        </div>
      </div>
  ...
  class CollatzGame {
    ...
    updatePlayerStatus() {
      if (this.playerName) {
        ...
        this.playerStatusDiv.innerHTML = '<small style="color: #28a745;">✅ Ready to save scores!</small>';
      } else {
    ...
    updateDisplay() {
      if (this.currentNumber === 0) {
        ...
        this.sequenceDiv.innerHTML = this.sequence.map((num, index) => {
          ...
          return `<span class="${className}">${num}</span>${index < this.sequence.length - 1 ? ' → ' : ''}`;
        }).join('');
      }
    }
    ...
    async showVictory() {
      ...
      if (this.steps === this.playerGuess) {
        resultMessage = `<strong>🎉 Perfect Guess!</strong> You correctly predicted ${this.steps} steps!`;
        ...
        savingMsg.innerHTML = `<br><div class="alert alert-info">
          <strong>⏳ Saving to Global Leaderboard...</strong>
        ...
        resultMessage = `<strong>🎯 Great Guess!</strong> You were off by only ${difference} step${difference === 1 ? '' : 's'}! Actual: ${this.steps}, Your guess: ${this.playerGuess}`;
        ...
        resultMessage = `<strong>👍 Good Guess!</strong> You were off by ${difference} steps. Actual: ${this.steps}, Your guess: ${this.playerGuess}`;
        ...
        resultMessage = `<strong>🤔 Nice Try!</strong> You were off by ${difference} steps. Actual: ${this.steps}, Your guess: ${this.playerGuess}`;
    ...
    async checkLeaderboard(startingNumber, steps) {
      ...
      if (this.playerName) {
        ...
        const setupChoice = confirm(`🎉 Congratulations! You made a perfect guess for starting number ${startingNumber} with ${steps} steps!\n\nTo save your score to the global leaderboard, you need to enter your name. Would you like to do that now?`);
    ...
    async addToLeaderboard(startingNumber, steps, playerIdentifier) {
      ...
      try {
        ...
        successMsg.innerHTML = `<br><div class="alert alert-success">
          <strong>🏆 Score Successfully Saved!</strong>
